...
1. Start from the project docs: `GEMINI.md`, `docs/0001-zero-config-infrastructure.md`, and `docs/0002-driver-communication-layer.md`.
...
4. Keep documentation synchronized when architecture or workflow changes.
